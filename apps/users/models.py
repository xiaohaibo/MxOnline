...
#     users = models.CharField(max_length=150,verbose_name="留言信息")
#
#     class Meta:
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name="验证码类型", max_length=10 , choices=(("register",u"注册"),("forget",u"找回密码")))
